...
public class HomeFragment extends Fragment {
    ...
    private void initData() {
        ...
        homeModelList.add(new HomeModel(R.drawable.bg_post1, "TRM Laundry", "Ksh.3,400", "Distance 1.4 km" ));
        homeModelList.add(new HomeModel(R.drawable.bg_post2, "Mwangi DryLaundry", "Ksh.2,400", "Distance 1.4 km" ));
        homeModelList.add(new HomeModel(R.drawable.bg_post3, "Roysambu Laundry", "Ksh.5,400", "Distance 2.4 km" ));
    }
